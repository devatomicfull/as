...
Este projeto utiliza a API moderna *CameraX* do Android Jetpack para realizar captura de imagens com suporte a ciclo de vida.

[[app1]]
=== App1: Captura com Preview

Breve descrição do App1.
